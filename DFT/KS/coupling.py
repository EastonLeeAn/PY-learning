...
class StructureOptimizer:
    ...
    def energy(self, positions):
        ...
        total_energy = self.potential_function(positions)
        return total_energy
...
def scf_structure_optimization(initial_positions, potential_function):
...
if __name__ == "__main__":
    ...
    optimized_positions = scf_structure_optimization(initial_positions, potential_function)
